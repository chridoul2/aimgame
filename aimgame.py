...
def eval_genomes(genomes, config):
    ...
    distance = 0 # distnce betwenn the yellow and red circle 
    oldDistance = 0
    ...
    yellowCirclePosX = 960
    yellowCirclePosY = 540
    click = False
    ge = []
    nets = []
    ...
    while run:
        ...
        #prints
            if(game==True and gameCounter < runs):
                ...
                pygame.draw.circle(screen, YELLOW,(yellowCirclePosX,yellowCirclePosY),15)



                if yellowCirclePosY<50 or yellowCirclePosY >1070 or yellowCirclePosX< 10 or yellowCirclePosX>1910:
                    ge[gameCounter].fitness -= 10


                sqx = (yellowCirclePosX -randx)**2
                sqy = (yellowCirclePosY - randy)**2

                distance = math.sqrt(sqx + sqy)

                if distance > oldDistance:
                    ge[gameCounter].fitness += 15
                else:
                    ge[gameCounter].fitness -= 20
                

                widthDiff = abs(yellowCirclePosX-randx)
                heightDiff = abs(yellowCirclePosY-randy)
